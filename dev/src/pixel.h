...
#pragma warning(default:4201)
	...
	public:
		...
		{
			uint8_t nR = uint8_t(std::clamp((int(r) * int(p.r)) / 255, 0, 255));
			uint8_t nG = uint8_t(std::clamp((int(g) * int(p.g)) / 255, 0, 255));
			uint8_t nB = uint8_t(std::clamp((int(b) * int(p.b)) / 255, 0, 255));
			uint8_t nA = uint8_t(std::clamp((int(a) * int(p.a)) / 255, 0, 255));
