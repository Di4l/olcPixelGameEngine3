...
/*
	olc::PixelGameEngine3 Example - Shockwave Pixel Shader

	Click to launch expanding shockwave effect.
...
class Example_Shockwave : public olc::PixelGameEngine
{
public:
	Example_Shockwave()
	{
